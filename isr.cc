...
void getCounter(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  info.GetReturnValue().Set(eventCounter);
}

void getConflictCount(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  info.GetReturnValue().Set(conflictCount);
}

void getIgnoredCount(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void Init(v8::Local<v8::Object> exports) {
  ...
  exports->Set(Nan::New("getCounter").ToLocalChecked(),
               Nan::New<v8::FunctionTemplate>(getCounter)->GetFunction());
  exports->Set(Nan::New("getIgnoredCount").ToLocalChecked(),
               Nan::New<v8::FunctionTemplate>(getIgnoredCount)->GetFunction());
  exports->Set(Nan::New("getConflictCount").ToLocalChecked(),
               Nan::New<v8::FunctionTemplate>(getConflictCount)->GetFunction());
}
